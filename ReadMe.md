...
# SmartMover API JAVA REST Sample Code

This is a sample code for Melissa's SmartMover API. It is written in JAVA and accesses the API through REST. 
This sample is intended to show the functionality of the SmartMover Web Service and how to call the service in JAVA. 
...
To subscribe to the SmartMover Web Service, please contact our sales department at 800-MELISSA ext. 3 (800-635-4772 ext. 3).
...
SmartMover Web Service is a trademark and 1-800-MELISSA is a registered trademark
